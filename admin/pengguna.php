...
<div class="main-content container-fluid">
    ...
    <a href="tmbh_pengguna.php" class="btn btn-primary round">Tambah Data</a>
                                    ...
                                    while ($d = mysqli_fetch_array($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                            ...
                                                            echo $roleLabel;
                                                            ?></td>
                                            <td><img src="../images/<?php echo $d['foto']; ?>" width="50"></td>
                                            <td>
                                            <a href="edit_pengguna.php?id=<?=$d['id_user'];?>" class="btn btn-warning">EDIT</a>
                                                <a href="hapus_pengguna.php?id=<?=$d['id_user'];?>" class="btn btn-danger">HAPUS</a>
                                                </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
