...
<div class="main-content container-fluid">
    ...
    <a href="tmbh_pasien.php" class="btn btn-primary round">Tambah Data</a>
    <div class="table-responsive">
          ...
          <thead>
                                    ...
                                    <?php 
                                        include '../koneksi.php';
                                        $data = mysqli_query($koneksi, "SELECT pasien.id_pasien, users.nama, users.alamat, pasien.bpjs, users.foto FROM pasien JOIN users ON pasien.id_user = users.id_user");
                                        if (!$data) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $d['alamat']; ?></td>
                                            <td><?= $d['bpjs']; ?></td>
                                            <td><img src=" <?php echo $d['foto']; ?>" width="50"></td>
                                            <td>
                                            <a href="edit_pasien.php?id=<?= $d['id_pasien']; ?>" class="btn btn-warning">EDIT</a>
                                                <a href="hapus_pasien.php?id=<?= $d['id_pasien']; ?>" class="btn btn-danger">HAPUS</a>
                                                </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
