...
<head>
    ...
    <title>Data Transaksi Obat</title>
...
<div class="main-content container-fluid">
    ...
    <a href="tmbh_data_transaksi.php" class="btn btn-primary round">Tambah Data</a>
    <div class="table-responsive">
          <table class="table table-light mb-0">
           <thead>
                                    ...
                                    <?php
include '../koneksi.php';
$data = mysqli_query($koneksi, "SELECT * FROM transaksi_obat ");
while ($d = mysqli_fetch_array($data)) {
    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="edit_transaksi.php?id=<?=$d['id_transaksi'];?>" class="btn btn-warning">EDIT</a>
                                                <a href="hapus_transaksi.php?id=<?=$d['id_transaksi'];?>" class="btn btn-danger">HAPUS</a>
                                                </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
