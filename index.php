                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                <a class="btn_2" href="auth/auth.php">login</a>
                                </li>
                            </ul>
                        </div>
...
<!-- Copright &copy;<script>document.write(new Date().getFullYear());</script><i class="ti-heart" aria-hidden="true"></i> by <a href="#" target="_blank"></a> -->
